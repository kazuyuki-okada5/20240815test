                    ...
                    <form method="POST" action="{{ route('items.create') }}" enctype="multipart/form-data">
                        ...
                        <div class="item-detail">
                            <div class="form-group">
                                <label class="item-type" for="categories">カテゴリー（最大3つまで選択可能）</label>
                            ...
                            <div class="form-group">
                                <label class="item-type" for="condition">商品の状態</label>
                        ...
                        <div class="item-detail">
                            <div class="form-group">
                                <label class="item-type" for="name">商品名</label>
                            ...
                            <div class="form-group">
                                <label class="item-type" for="brand">ブランド</label>
                            ...
                            <div class="form-group">
                                <label class="item-type" for="comment">商品の説明</label>
                        ...
                        <div class="form-group">
                            <label class="item-type" for="price">価格</label>
